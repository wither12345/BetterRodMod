...
public class EntityRenderersRegister {
    ...
    private static final Identifier BLAZE_HOOK = Identifier.parse("better_rod:textures/entity/blaze_hook.png");
    ...
    public static void onRenderEvent(EntityRenderersEvent.RegisterRenderers event){
        ...
        event.registerEntityRenderer(EntityRegister.BLAZE_HOOK.get(), context -> new HookEntityRenderer(context, BLAZE_HOOK));
